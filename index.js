...
// If it's between 7am and midnight (24-hour format), print "Unleash the beast!"
// Otherwise, print "Better stick to water."
let monsterEnergyMessage = currentHour >= 7 && currentHour < 23 ? 'Unleash the beast!' : 'Better stick to water.';// ternary to check hour
console.log (monsterEnergyMessage);//results 
